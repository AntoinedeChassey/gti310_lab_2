 ...
 * order to a caller. When the data reaches the end-of-file marker, it will
 * return nothing.
 * 
...
public class FileSource {
	 ...
	 *             If the path does not lead to a real file.
	 */
	...
	public DataInputStream skip(int size) {
		try {
			/* skip the bytes of the size we want */
			_reader.skip(size);

			/* return the file with skipped bytes */
			return _reader;
		} catch (IOException e) {
			/* something went wrong, or EOF reached */
			return null;
